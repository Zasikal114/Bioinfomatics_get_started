...
test@bioinfo_docker:~/linux$ vim 1.txt
test@bioinfo_docker:~/linux$ cp /home/test/linux/1.txt /home/test/share
test@bioinfo_docker:~/linux$ cd ..
test@bioinfo_docker:~$ cd share
test@bioinfo_docker:~/share$ ls
114.txt  1.txt  result.gtf  test_command.gtf
